...
* I injected the result of a Py3status class printing the number of open tickets on our local GLPI system. You can find this module's code in the **examples/glpi.py** file
